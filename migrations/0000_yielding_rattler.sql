...
ALTER TABLE "habits" ADD CONSTRAINT "habits_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_entries_habit_id" ON "entries" USING btree ("habit_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_habit_tag_unique" ON "habit_tags" USING btree ("habit_id","tag_id");--> statement-breakpoint
